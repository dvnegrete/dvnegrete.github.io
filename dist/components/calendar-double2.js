...
import { P as PositionRange, d as defineCustomElement$2 } from './calendar-single2.js';
...
const CalendarDouble = /*@__PURE__*/ proxyCustomElement(class CalendarDouble extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return calendarDoubleCss; }
}, [1, "calendar-double", {
    "mainDateReceived": [16],
    "typeSelection": [1, "type-selection"],
    "typeSelectionMain": [32],
    "typeSelectionSecondary": [32],
    "setCalendarMain": [32],
    "setCalendarSecond": [32],
    "calendarActive": [32],
    "rangeMain": [32],
    "positionRangeMain": [32],
    "positionRangeSecondary": [32]
  }, [[0, "dvn-previousMonthCalendar", "previousMonthCalendarEvent"], [0, "dvn-nextMonthCalendar", "nextMonthCalendarEvent"], [0, "dvn-valueCalendarSelected", "calendarSingleDaySelected"]], {
    "mainDateReceived": ["handlerChangeDateReceived"],
    "typeSelection": ["handlerTypeSelection"]
  }]);
function defineCustomElement() {
  ...
  const components = ["calendar-double", "calendar-single", "header-calendar"];
  components.forEach(tagName => { switch (tagName) {
    case "calendar-double":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalendarDouble);
      }
      break;
...
export { CalendarDouble as C, defineCustomElement as d };

//# sourceMappingURL=calendar-double2.js.map